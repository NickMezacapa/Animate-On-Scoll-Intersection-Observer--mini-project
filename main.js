...
/* Declare options object to use for intersection observer parameter, will need the rootMargin and a threshold. This will declare where and when the observed information will be observed and displayed */
let options = {
    rootMargin: '0px',
    threshold: .25
}
...
// Must be created after declaration of setItemActive
